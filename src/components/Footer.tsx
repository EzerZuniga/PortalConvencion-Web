...
export default function Footer() {
  ...
  <div className="max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-10 items-start">
    ...
    <div className="flex flex-col items-center md:items-start mb-6 md:mb-0">
            <Link to="/" className="flex justify-center items-center mb-3 group">
              <img src="/images/logo footer.png" alt="Logo Explorando La Convención" className="w-48 sm:w-56 md:w-64 h-auto shadow-lg transition-transform duration-200 group-hover:scale-105" />
            </Link>
  ...
  <nav aria-label="Navegación principal" className="mb-6 md:mb-0">
          ...
          <ul className="flex flex-col gap-2 text-base">
            <li>
              <a href="/" className="flex items-center gap-2 px-2 py-1 text-gray-200 hover:text-green-400 transition-colors">
                <span className="text-green-400 text-lg">›</span>Inicio
              </a>
            </li>
            <li>
              <a href="/destinations" className="flex items-center gap-2 px-2 py-1 text-gray-200 hover:text-green-400 transition-colors">
                <span className="text-green-400 text-lg">›</span>Destinos
              </a>
            </li>
            <li>
              <a href="/gallery" className="flex items-center gap-2 px-2 py-1 text-gray-200 hover:text-green-400 transition-colors">
                <span className="text-green-400 text-lg">›</span>Galería
              </a>
            </li>
            <li>
              <a href="/tips" className="flex items-center gap-2 px-2 py-1 text-gray-200 hover:text-green-400 transition-colors">
                <span className="text-green-400 text-lg">›</span>Consejos de viaje
              </a>
            </li>
            <li>
              <a href="/contact" className="flex items-center gap-2 px-2 py-1 text-gray-200 hover:text-green-400 transition-colors">
